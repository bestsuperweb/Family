...
{	
	...
	private function get_family_content($id){
		...
		$header .= "<h1 style='color: #542a44;'>Initial registeration family ".$parents[0][last_name]."</h1>";

		$hmtl = '<h2 style="color: #542a44;">1. Basic Info</h2>';
		...
		foreach ($kids as $key => $kid) {
			...
			$html .= "<tr><td>Gender child ".( $key + 1 )."</td><td>".$kid[gemder]."</td></tr>";
		...
		$html .= "<tr><td>Religion</td><td>".$family[relition]."</td></tr>";
		...
		$html .= "<tr><td>Do you dinner together?</td><td>".$familyp[eating]."</td></tr>";
