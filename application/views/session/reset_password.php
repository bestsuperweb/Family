...
<html lang="en">
<head>
  <title>Reset Password | HBN </title>
  <meta charset="utf-8">
...
<div class="login">
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="user_id" id="inputUserID" value="<?=$this->uri->segment(3)?>" placeholder="User Name" required>
      </div>
      <div class="form-group">
        <input type="text" class="form-control" name="verification_code" id="inputVerCode" value="<?=$this->uri->segment(4)?>" required>        
      </div>
      <div class="form-group">
        <input type="submit" name="" value="REMIND PASSWORD" class="btn login-btn">    
      </div>
      </form>
      <div class="form-group">
        <a href="<?= base_url('/session_controller/log_in'); ?>">Back to login</a>
